...
public class MethodReachabilityDetectorTest {
    ...
    private MethodReachabilityDetector methodReachabilityDetector;
    ...
    @Before
    public void setup() {
        methodReachabilityDetector = new MethodReachabilityDetector();
    }
    ...
    public void testMapReachability() throws Exception {
        ...
        methodReachabilityDetector.optimize(FakeMapUsername, classMap);
